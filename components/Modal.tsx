...
export default function Modal({ isOpen, onClose, children, title, size = 'medium', hasFooter }: ModalProps) {
    ...
    return createPortal(
        <div
            ...
            <div
                style={{
                    backgroundColor: isDark ? 'rgba(13,51,64,0.5)' : 'rgba(255,255,255,0.8)',
                    borderRadius: '1rem',
                    ...
                    {hasFooter ?
                        <section>
                            ...
                            <button className='button is-green text-white'
                                    style={{ fontWeight: '500', cursor: 'pointer' }}>Save</button>
