...
const data: DataItem[] = [
  ...
  { name: "Industrials", value: 631, colorFrom: "text-purple-300", colorTo: "text-purple-600" },
  { name: "Cyclical", value: 331, colorFrom: "text-indigo-300", colorTo: "text-indigo-500" },
  { name: "Energy", value: 232, colorFrom: "text-sky-300", colorTo: "text-sky-500" },
  { name: "Defensive", value: 101, colorFrom: "text-lime-300", colorTo: "text-lime-600" },
  { name: "Financials", value: 42, colorFrom: "text-amber-200", colorTo: "text-amber-500" },
];
